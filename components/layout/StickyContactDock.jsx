...
export default function StickyContactDock() {
  return (
    <>
      <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp Me" className="whatsapp-float">
      ...
      <div className="mobile-action-bar">
        <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp Me" className="mobile-action-whatsapp">WhatsApp</a>
        <a href={BOOK_CALL_URL} className="mobile-action-book">Book a Call</a>
      </div>
    </>
  );
}
