...
function SocialIcons() {
  return (
    <>
      <a href="https://www.linkedin.com/in/raghavkanva/" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer" {...gtmAttrs('social_click', { social_network: 'linkedin', click_location: 'footer' })}>
      ...
      <a href="https://www.instagram.com/raghavkanva/" aria-label="Instagram" target="_blank" rel="noopener noreferrer" {...gtmAttrs('social_click', { social_network: 'instagram', click_location: 'footer' })}>
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
          <rect x="3" y="3" width="18" height="18" rx="5" /><circle cx="12" cy="12" r="4" /><circle cx="17.2" cy="6.8" r="1" />
        </svg>
      </a>
      <a href="https://www.threads.net/@raghavkanva" aria-label="Threads" target="_blank" rel="noopener noreferrer" {...gtmAttrs('social_click', { social_network: 'threads', click_location: 'footer' })}>
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
    ...
    <footer className="site-footer">
      ...
      <div className="footer-top">
        ...
        <div className="footer-links">
          <a href={BOOK_CALL_URL} {...gtmAttrs('contact_click', { contact_method: 'call', click_location: 'footer' })}>Discovery Call</a>
          <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" {...gtmAttrs('contact_click', { contact_method: 'whatsapp', click_location: 'footer' })}>WhatsApp</a>
          <a href="mailto:raghavkanva@gmail.com" {...gtmAttrs('contact_click', { contact_method: 'email', click_location: 'footer' })}>Email</a>
        </div>
      </div>
